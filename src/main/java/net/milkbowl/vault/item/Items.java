...
public class Items {
    ...
    static {
        ...
        **/
        ...
        awkwardMeta.setBasePotionData(new PotionData(PotionType.AWKWARD));
        awkwardPotion.setItemMeta(awkwardMeta);
        items.add(new ItemInfo("Awkward Potion", new String[][] {{"poti", "awk"}}, awkwardPotion));
        ItemStack thickPotion = new ItemStack(Material.POTION, 1);
        PotionMeta thickMeta = (PotionMeta) thickPotion.getItemMeta();
        thickMeta.setBasePotionData(new PotionData(PotionType.THICK));
        thickPotion.setItemMeta(thickMeta);
        items.add(new ItemInfo("Thick Potion", new String[][] {{"poti", "thic"}}, thickPotion));
        ItemStack mundaneExt = new ItemStack(Material.POTION, 1);
        PotionMeta mundaneExtMeta = (PotionMeta) mundaneExt.getItemMeta();
        mundaneExtMeta.setBasePotionData(new PotionData(PotionType.MUNDANE, true, false));
        mundaneExt.setItemMeta(mundaneExtMeta);
        items.add(new ItemInfo("Mundane Potion (Extended)", new String[][] {{"poti", "mund", "ext"}}, mundaneExt));
        ItemStack mundanePotion = new ItemStack(Material.POTION, 1);
        PotionMeta mundaneMeta = (PotionMeta) mundanePotion.getItemMeta();
        mundaneMeta.setBasePotionData(new PotionData(PotionType.MUNDANE));
        mundanePotion.setItemMeta(mundaneMeta);
        items.add(new ItemInfo("Mundane Potion", new String[][] {{"poti", "mund"}}, mundanePotion));
        ItemStack regenPotion = new ItemStack(Material.POTION, 1);
        PotionMeta regenMeta = (PotionMeta) regenPotion.getItemMeta();
        regenMeta.setBasePotionData(new PotionData(PotionType.REGEN));
        regenPotion.setItemMeta(regenMeta);
        items.add(new ItemInfo("Potion of Regeneration", new String[][] {{"poti", "rege"}}, regenPotion));
        ItemStack regenExt = new ItemStack(Material.POTION, 1);
        PotionMeta regenExtMeta = (PotionMeta) regenExt.getItemMeta();
        regenExtMeta.setBasePotionData(new PotionData(PotionType.REGEN, true, false));
        regenExt.setItemMeta(regenExtMeta);
        items.add(new ItemInfo("Potion of Regeneration (Extended)", new String[][] {{"poti", "rege", "ext"}}, regenExt));
        ItemStack regen2 = new ItemStack(Material.POTION, 1);
        PotionMeta regen2Meta = (PotionMeta) regen2.getItemMeta();
        regen2Meta.setBasePotionData(new PotionData(PotionType.REGEN, false, true));
        regen2.setItemMeta(regen2Meta);
        items.add(new ItemInfo("Potion of Regeneration II", new String[][] {{"poti", "rege", "2"}, {"poti", "rege", "ii"}}, regen2));
        ItemStack swiftnessPotion = new ItemStack(Material.POTION, 1);
        PotionMeta swiftnessMeta = (PotionMeta) swiftnessPotion.getItemMeta();
        swiftnessMeta.setBasePotionData(new PotionData(PotionType.SPEED));
        swiftnessPotion.setItemMeta(swiftnessMeta);
        items.add(new ItemInfo("Potion of Swiftness", new String[][] {{"poti", "swif"}, {"poti", "speed"}}, swiftnessPotion));
        ItemStack swiftnessExt = new ItemStack(Material.POTION, 1);
        PotionMeta swiftnessExtMeta = (PotionMeta) swiftnessExt.getItemMeta();
        swiftnessExtMeta.setBasePotionData(new PotionData(PotionType.SPEED, true, false));
        swiftnessExt.setItemMeta(swiftnessExtMeta);
        items.add(new ItemInfo("Potion of Swiftness (Extended)", new String[][] {{"poti", "swif", "ext"}, {"poti", "speed", "ext"}}, swiftnessExt));
        ItemStack swiftness2 = new ItemStack(Material.POTION, 1);
        PotionMeta swiftness2Meta = (PotionMeta) swiftness2.getItemMeta();
        swiftness2Meta.setBasePotionData(new PotionData(PotionType.SPEED, false, true));
        swiftness2.setItemMeta(swiftness2Meta);
        items.add(new ItemInfo("Potion of Swiftness II", new String[][] {{"poti", "swif", "2"}, {"poti", "swif", "ii"}, {"poti", "speed", "2"}, {"poti", "speed", "ii"}}, swiftness2));
        ItemStack fireResistPotion = new ItemStack(Material.POTION, 1);
        PotionMeta fireResistMeta = (PotionMeta) fireResistPotion.getItemMeta();
        fireResistMeta.setBasePotionData(new PotionData(PotionType.FIRE_RESISTANCE));
        fireResistPotion.setItemMeta(fireResistMeta);
        items.add(new ItemInfo("Potion of Fire Resistance", new String[][] {{"poti", "fire"}}, fireResistPotion));
        ItemStack fireResistExt = new ItemStack(Material.POTION, 1);
        PotionMeta fireResistExtMeta = (PotionMeta) fireResistExt.getItemMeta();
        fireResistExtMeta.setBasePotionData(new PotionData(PotionType.FIRE_RESISTANCE, true, false));
        fireResistExt.setItemMeta(fireResistExtMeta);
        items.add(new ItemInfo("Potion of Fire Resistance (Extended)", new String[][] {{"poti", "fire", "ext"}}, fireResistExt));
        // items.add(new ItemInfo("Potion of Fire Resistance (Reverted)", new String[][] {{"poti", "fire", "rev"}}, Material.POTION, (short) 8227)); <-- Dropped in MC 1.9
        ItemStack healingPotion = new ItemStack(Material.POTION, 1);
        PotionMeta healingMeta = (PotionMeta) healingPotion.getItemMeta();
        healingMeta.setBasePotionData(new PotionData(PotionType.INSTANT_HEAL));
        healingPotion.setItemMeta(healingMeta);
        items.add(new ItemInfo("Potion of Healing", new String[][] {{"poti", "heal"}}, healingPotion));
        // items.add(new ItemInfo("Potion of Healing (Reverted)", new String[][] {{"poti", "heal", "rev"}}, Material.POTION, (short) 8261)); <-- Dropped in MC 1.9
        ItemStack healing2 = new ItemStack(Material.POTION, 1);
        PotionMeta healing2Meta = (PotionMeta) healing2.getItemMeta();
        healing2Meta.setBasePotionData(new PotionData(PotionType.INSTANT_HEAL, false, true));
        healing2.setItemMeta(healing2Meta);
        items.add(new ItemInfo("Potion of Healing II", new String[][] {{"poti", "heal", "2"}, {"poti", "heal", "ii"}}, healing2));
        ...
        items.add(new ItemInfo("Potion of Strength", new String[][] {{"poti", "str"}}, strengthPotion));
        ItemStack strengthExt = new ItemStack(Material.POTION, 1);
        PotionMeta strengthExtMeta = (PotionMeta) strengthExt.getItemMeta();
        strengthExtMeta.setBasePotionData(new PotionData(PotionType.STRENGTH, true, false));
        strengthExt.setItemMeta(strengthExtMeta);
        items.add(new ItemInfo("Potion of Strength (Extended)", new String[][] {{"poti", "str", "ext"}}, strengthExt));
        ItemStack strength2 = new ItemStack(Material.POTION, 1);
        PotionMeta strength2Meta = (PotionMeta) strength2.getItemMeta();
        strength2Meta.setBasePotionData(new PotionData(PotionType.STRENGTH, false, true));
        strength2.setItemMeta(strength2Meta);
        items.add(new ItemInfo("Potion of Strength II", new String[][] {{"poti", "str", "2"}, {"poti", "str", "ii"}}, strength2));
        ...
        items.add(new ItemInfo("Potion of Poison", new String[][] {{"poti", "pois"}}, poisonPotion));
        ItemStack poisonExt = new ItemStack(Material.POTION, 1);
        PotionMeta poisonExtMeta = (PotionMeta) poisonExt.getItemMeta();
        poisonExtMeta.setBasePotionData(new PotionData(PotionType.POISON, true, false));
        poisonExt.setItemMeta(poisonExtMeta);
        items.add(new ItemInfo("Potion of Poison (Extended)", new String[][] {{"poti", "pois", "ext"}}, poisonExt));
        ItemStack poison2 = new ItemStack(Material.POTION, 1);
        PotionMeta poison2Meta = (PotionMeta) poison2.getItemMeta();
        poison2Meta.setBasePotionData(new PotionData(PotionType.POISON, false, true));
        poison2.setItemMeta(poison2Meta);
        items.add(new ItemInfo("Potion of Poison II", new String[][] {{"poti", "pois", "2"}, {"poti", "pois", "ii"}}, poison2));
        ItemStack weaknessPotion = new ItemStack(Material.POTION, 1);
        PotionMeta weaknessMeta = (PotionMeta) weaknessPotion.getItemMeta();
        weaknessMeta.setBasePotionData(new PotionData(PotionType.WEAKNESS));
        weaknessPotion.setItemMeta(weaknessMeta);
        items.add(new ItemInfo("Potion of Weakness", new String[][] {{"poti", "weak"}}, weaknessPotion));
        ItemStack weaknessExt = new ItemStack(Material.POTION, 1);
        PotionMeta weaknessExtMeta = (PotionMeta) weaknessExt.getItemMeta();
        weaknessExtMeta.setBasePotionData(new PotionData(PotionType.WEAKNESS, true, false));
        weaknessExt.setItemMeta(weaknessExtMeta);
        items.add(new ItemInfo("Potion of Weakness (Extended)", new String[][] {{"poti", "weak", "ext"}}, weaknessExt));
        // items.add(new ItemInfo("Potion of Weakness (Reverted)", new String[][] {{"poti", "weak", "rev"}}, Material.POTION, (short) 8232)); <-- Removed in MC 1.9
        ...
        items.add(new ItemInfo("Potion of Slowness", new String[][] {{"poti", "slow"}}, slownessPotion));
        ItemStack slownessExt = new ItemStack(Material.POTION, 1);
        PotionMeta slownessExtMeta = (PotionMeta) slownessExt.getItemMeta();
        slownessExtMeta.setBasePotionData(new PotionData(PotionType.SLOWNESS, true, false));
        slownessExt.setItemMeta(slownessExtMeta);
        items.add(new ItemInfo("Potion of Slowness (Extended)", new String[][] {{"poti", "slow", "ext"}}, slownessExt));
        // items.add(new ItemInfo("Potion of Slowness (Reverted)", new String[][] {{"poti", "slow", "rev"}}, Material.POTION, (short) 8234)); <-- Removed in MC 1.9
        ItemStack harmingPotion = new ItemStack(Material.POTION, 1);
        PotionMeta harmingMeta = (PotionMeta) harmingPotion.getItemMeta();
        harmingMeta.setBasePotionData(new PotionData(PotionType.INSTANT_DAMAGE));
        harmingPotion.setItemMeta(harmingMeta);
        items.add(new ItemInfo("Potion of Harming", new String[][] {{"poti", "harm"}}, harmingPotion));
        // items.add(new ItemInfo("Potion of Harming (Reverted)", new String[][] {{"poti", "harm", "rev"}}, Material.POTION, (short) 8268)); <-- Removed in MC 1.9
        ItemStack harming2 = new ItemStack(Material.POTION, 1);
        PotionMeta harming2Meta = (PotionMeta) harming2.getItemMeta();
        harming2Meta.setBasePotionData(new PotionData(PotionType.INSTANT_DAMAGE, false, true));
        harming2.setItemMeta(harming2Meta);
        items.add(new ItemInfo("Potion of Harming II", new String[][] {{"poti", "harm", "2"}, {"poti", "harm", "ii"}}, harming2));
        ItemStack splashMundane = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashMundaneMeta = (PotionMeta) splashMundane.getItemMeta();
        splashMundaneMeta.setBasePotionData(new PotionData(PotionType.MUNDANE));
        splashMundane.setItemMeta(splashMundaneMeta);
        items.add(new ItemInfo("Splash Mundane Potion", new String[][] {{"poti", "mund", "spl"}}, splashMundane));
        ItemStack splashRegen = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashRegenMeta = (PotionMeta) splashRegen.getItemMeta();
        splashRegenMeta.setBasePotionData(new PotionData(PotionType.REGEN));
        splashRegen.setItemMeta(splashRegenMeta);
        items.add(new ItemInfo("Splash Potion of Regeneration", new String[][] {{"poti", "rege", "spl"}}, splashRegen));
        ItemStack splashRegenExt = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashRegenExtMeta = (PotionMeta) splashRegenExt.getItemMeta();
        splashRegenExtMeta.setBasePotionData(new PotionData(PotionType.REGEN, true, false));
        splashRegenExt.setItemMeta(splashRegenExtMeta);
        items.add(new ItemInfo("Splash Potion of Regeneration (Extended)", new String[][] {{"poti", "rege", "spl", "ext"}}, splashRegenExt));
        ItemStack splashRegen2 = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashRegen2Meta = (PotionMeta) splashRegen2.getItemMeta();
        splashRegen2Meta.setBasePotionData(new PotionData(PotionType.REGEN, false, true));
        splashRegen2.setItemMeta(splashRegen2Meta);
        items.add(new ItemInfo("Splash Potion of Regeneration II", new String[][] {{"poti", "rege", "spl", "2"}, {"poti", "rege", "spl", "ii"}}, splashRegen2));
        ItemStack splashSwift = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashSwiftMeta = (PotionMeta) splashSwift.getItemMeta();
        splashSwiftMeta.setBasePotionData(new PotionData(PotionType.SPEED));
        splashSwift.setItemMeta(splashSwiftMeta);
        items.add(new ItemInfo("Splash Potion of Swiftness", new String[][] {{"poti", "swif", "spl"}, {"poti", "speed", "spl"}}, splashSwift));
        ItemStack splashSwiftExt = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashSwiftExtMeta = (PotionMeta) splashSwiftExt.getItemMeta();
        splashSwiftExtMeta.setBasePotionData(new PotionData(PotionType.SPEED, true, false));
        splashSwiftExt.setItemMeta(splashSwiftExtMeta);
        items.add(new ItemInfo("Splash Potion of Swiftness (Extended)", new String[][] {{"poti", "swif", "spl", "ext"}, {"poti", "speed", "spl", "ext"}}, splashSwiftExt));
        ItemStack splashSwift2 = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashSwift2Meta = (PotionMeta) splashSwift2.getItemMeta();
        splashSwift2Meta.setBasePotionData(new PotionData(PotionType.SPEED, false ,true));
        splashSwift2.setItemMeta(splashSwift2Meta);
        items.add(new ItemInfo("Splash Potion of Swiftness II", new String[][] {{"poti", "swif", "spl", "2"}, {"poti", "swif", "spl", "ii"}, {"poti", "speed", "spl", "2"}, {"poti", "speed", "spl", "ii"}}, splashSwift2));
        ItemStack splashFireResist = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashFireResistMeta = (PotionMeta) splashFireResist.getItemMeta();
        splashFireResistMeta.setBasePotionData(new PotionData(PotionType.FIRE_RESISTANCE));
        splashFireResist.setItemMeta(splashFireResistMeta);
        items.add(new ItemInfo("Splash Potion of Fire Resistance", new String[][] {{"poti", "fire", "spl"}}, splashFireResist));
        ItemStack splashFireResistExt = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashFireResistExtMeta = (PotionMeta) splashFireResistExt.getItemMeta();
        splashFireResistExtMeta.setBasePotionData(new PotionData(PotionType.FIRE_RESISTANCE, true, false));
        splashFireResistExt.setItemMeta(splashFireResistExtMeta);
        items.add(new ItemInfo("Splash Potion of Fire Resistance (Extended)", new String[][] {{"poti", "fire", "spl", "ext"}}, splashFireResistExt));
        // items.add(new ItemInfo("Splash Potion of Fire Resistance (Reverted)", new String[][] {{"poti", "fire", "spl", "rev"}}, Material.POTION, (short) 16419)); <-- Removed in MC 1.9
        ItemStack splashHealing = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashHealingMeta = (PotionMeta) splashHealing.getItemMeta();
        splashHealingMeta.setBasePotionData(new PotionData(PotionType.INSTANT_HEAL));
        splashHealing.setItemMeta(splashHealingMeta);
        items.add(new ItemInfo("Splash Potion of Healing", new String[][] {{"poti", "heal", "spl"}}, splashHealing));
        // items.add(new ItemInfo("Splash Potion of Healing (Reverted)", new String[][] {{"poti", "heal", "spl", "rev"}}, Material.POTION, (short) 16453)); <-- Removed in MC 1.9
        ItemStack splashHealing2 = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashHealing2Meta = (PotionMeta) splashHealing2.getItemMeta();
        splashHealing2Meta.setBasePotionData(new PotionData(PotionType.INSTANT_HEAL, false, true));
        splashHealing2.setItemMeta(splashHealing2Meta);
        items.add(new ItemInfo("Splash Potion of Healing II", new String[][] {{"poti", "heal", "spl", "2"}, {"poti", "heal", "spl", "ii"}}, splashHealing2));
        ItemStack splashStrength = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashStrengthMeta = (PotionMeta) splashStrength.getItemMeta();
        splashStrengthMeta.setBasePotionData(new PotionData(PotionType.STRENGTH));
        splashStrength.setItemMeta(splashStrengthMeta);
        items.add(new ItemInfo("Splash Potion of Strength", new String[][] {{"poti", "str", "spl"}}, splashStrength));
        ItemStack splashStrengthExt = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashStrengthExtMeta = (PotionMeta) splashStrengthExt.getItemMeta();
        splashStrengthExtMeta.setBasePotionData(new PotionData(PotionType.STRENGTH, true, false));
        splashStrengthExt.setItemMeta(splashStrengthExtMeta);
        items.add(new ItemInfo("Splash Potion of Strength (Extended)", new String[][] {{"poti", "str", "spl", "ext"}}, splashStrengthExt));
        ItemStack splashStrength2 = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashStrength2Meta = (PotionMeta) splashStrength2.getItemMeta();
        splashStrength2Meta.setBasePotionData(new PotionData(PotionType.STRENGTH, false, true));
        splashStrength2.setItemMeta(splashStrength2Meta);
        items.add(new ItemInfo("Splash Potion of Strength II", new String[][] {{"poti", "str", "spl", "2"}, {"poti", "str", "spl", "ii"}}, splashStrength2));
        ItemStack splashPoison = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashPoisonMeta = (PotionMeta) splashPoison.getItemMeta();
        splashPoisonMeta.setBasePotionData(new PotionData(PotionType.POISON));
        splashPoison.setItemMeta(splashPoisonMeta);
        items.add(new ItemInfo("Splash Potion of Poison", new String[][] {{"poti", "pois", "spl"}}, splashPoison));
        ItemStack splashPoisonExt = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashPoisonExtMeta = (PotionMeta) splashPoisonExt.getItemMeta();
        splashPoisonExtMeta.setBasePotionData(new PotionData(PotionType.POISON, true, false));
        splashPoisonExt.setItemMeta(splashPoisonExtMeta);
        items.add(new ItemInfo("Splash Potion of Poison (Extended)", new String[][] {{"poti", "pois", "spl", "ext"}}, splashPoisonExt));
        ItemStack splashPoison2 = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashPoison2Meta = (PotionMeta) splashPoison2.getItemMeta();
        splashPoison2Meta.setBasePotionData(new PotionData(PotionType.POISON, false, true));
        splashPoison2.setItemMeta(splashPoison2Meta);
        items.add(new ItemInfo("Splash Potion of Poison II", new String[][] {{"poti", "pois", "spl", "2"}, {"poti", "pois", "spl", "ii"}}, splashPoison2));
        ItemStack splashWeakness = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashWeaknessMeta = (PotionMeta) splashWeakness.getItemMeta();
        splashWeaknessMeta.setBasePotionData(new PotionData(PotionType.WEAKNESS));
        splashWeakness.setItemMeta(splashWeaknessMeta);
        items.add(new ItemInfo("Splash Potion of Weakness", new String[][] {{"poti", "weak", "spl"}}, splashWeakness));
        ItemStack splashWeaknessExt = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashWeaknessExtMeta = (PotionMeta) splashWeaknessExt.getItemMeta();
        splashWeaknessExtMeta.setBasePotionData(new PotionData(PotionType.WEAKNESS, true, false));
        splashWeaknessExt.setItemMeta(splashWeaknessExtMeta);
        items.add(new ItemInfo("Splash Potion of Weakness (Extended)", new String[][] {{"poti", "weak", "spl", "ext"}}, splashWeaknessExt));
        // items.add(new ItemInfo("Splash Potion of Weakness (Reverted)", new String[][] {{"poti", "weak", "spl", "rev"}}, Material.POTION, (short) 16424)); <-- Removed in MC 1.9
        ItemStack splashSlowness = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashSlownessMeta = (PotionMeta) splashSlowness.getItemMeta();
        splashSlownessMeta.setBasePotionData(new PotionData(PotionType.SLOWNESS));
        splashSlowness.setItemMeta(splashSlownessMeta);
        items.add(new ItemInfo("Splash Potion of Slowness", new String[][] {{"poti", "slow", "spl"}}, splashSlowness));
        ItemStack splashSlownessExt = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashSlownessExtMeta = (PotionMeta) splashSlownessExt.getItemMeta();
        splashSlownessExtMeta.setBasePotionData(new PotionData(PotionType.SLOWNESS, true, false));
        splashSlownessExt.setItemMeta(splashSlownessExtMeta);
        items.add(new ItemInfo("Splash Potion of Slowness (Extended)", new String[][] {{"poti", "slow", "spl", "ext"}}, splashSlownessExt));
        // items.add(new ItemInfo("Splash Potion of Slowness (Reverted)", new String[][] {{"poti", "slow", "spl", "rev"}}, Material.POTION, (short) 16426)); <-- Removed in MC 1.9
        ItemStack splashHarming = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashHarmingMeta = (PotionMeta) splashHarming.getItemMeta();
        splashHarmingMeta.setBasePotionData(new PotionData(PotionType.INSTANT_DAMAGE));
        splashHarming.setItemMeta(splashHarmingMeta);
        items.add(new ItemInfo("Splash Potion of Harming", new String[][] {{"poti", "harm", "spl"}}, splashHarming));
        // items.add(new ItemInfo("Splash Potion of Harming (Reverted)", new String[][] {{"poti", "harm", "spl", "rev"}}, Material.POTION, (short) 16460)); <-- Removed in MC 1.9
        ItemStack splashHarming2 = new ItemStack(Material.SPLASH_POTION, 1);
        PotionMeta splashHarming2Meta = (PotionMeta) splashHarming2.getItemMeta();
        splashHarming2Meta.setBasePotionData(new PotionData(PotionType.INSTANT_DAMAGE, false, true));
        splashHarming2.setItemMeta(splashHarming2Meta);
        items.add(new ItemInfo("Splash Potion of Harming II", new String[][] {{"poti", "harm", "spl", "2"}, {"poti", "harm", "spl", "ii"}}, splashHarming2));
